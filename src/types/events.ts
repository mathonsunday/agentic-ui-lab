...
/**
 * Legacy SSE event format - deprecated but kept for backward compatibility
 */
...
/**
 * Converts legacy event to new envelope format
 */
export function convertLegacyEvent(
  legacy: LegacyStreamEvent,
  eventId: string,
  ...
  switch (legacy.type) {
    ...
    case 'response_chunk':
      return {
        ...
        parent_event_id: parentId,
        data: {
          chunk: (legacy.data as any).chunk,
          chunk_index: 0,
        },
      };
    ...
    case 'error':
      return {
        ...
        data: {
          code: 'STREAM_ERROR',
          message: (legacy.data as any).message,
          recoverable: false,
        },
      };
    ...
    default:
      return {
        ...
        data: {
          code: 'UNKNOWN_EVENT',
          message: `Unknown event type: ${legacy.type}`,
          recoverable: true,
        },
      };
  }
